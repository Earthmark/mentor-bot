...
public class SignalWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    public Mock<IResoniteApi> NeosApi { get; } = new();
    ...
    {
        return new SignalContext(Services.GetRequiredService<DbContextOptions<SignalContext>>());
    }
...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection Replace<IService>(this IServiceCollection services, IService instance)
