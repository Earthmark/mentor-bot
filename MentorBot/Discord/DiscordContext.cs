...
public class DiscordContext : IDiscordContext, IHostedService, IDisposable
{
    ...
    {
        if (Channel == null) throw new InvalidOperationException("channel not bound to discord context.");
    ...
    public async ValueTask<IUserMessage?> UpdateMessageAsync(ulong id, Embed embed,
